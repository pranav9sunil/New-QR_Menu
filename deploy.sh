...
echo "Skipping interactive login (User already authenticated)..."
# vercel login
...
echo "AIzaSyAT2acMkrTKsMMaW2aR5aGLTMdYQbje7i8" | npx vercel env add VITE_FIREBASE_API_KEY production

echo "Adding VITE_FIREBASE_AUTH_DOMAIN..."
echo "qr-ordering-system-c80d4.firebaseapp.com" | npx vercel env add VITE_FIREBASE_AUTH_DOMAIN production

echo "Adding VITE_FIREBASE_PROJECT_ID..."
echo "qr-ordering-system-c80d4" | npx vercel env add VITE_FIREBASE_PROJECT_ID production

echo "Adding VITE_FIREBASE_STORAGE_BUCKET..."
echo "qr-ordering-system-c80d4.firebasestorage.app" | npx vercel env add VITE_FIREBASE_STORAGE_BUCKET production

echo "Adding VITE_FIREBASE_MESSAGING_SENDER_ID..."
echo "380518528753" | npx vercel env add VITE_FIREBASE_MESSAGING_SENDER_ID production

echo "Adding VITE_FIREBASE_APP_ID..."
echo "1:380518528753:web:4893e0ed933138b5f99b50" | npx vercel env add VITE_FIREBASE_APP_ID production
